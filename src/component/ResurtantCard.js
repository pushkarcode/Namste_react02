...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="w-[18vw] h-[47vh] bg-zinc-200 rounded-t-lg rounded-b-sm shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] overflow-hidden hover:shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] transition-all ease-linear hover:scale-105">
      <img
